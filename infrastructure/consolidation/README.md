...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_guardrail_consolidation"></a> [guardrail\_consolidation](#module\_guardrail\_consolidation) | ../modules/guardrail_registry | n/a |
...
| <a name="input_shared_account_ids"></a> [shared\_account\_ids](#input\_shared\_account\_ids) | Accepted from shared tfvars but unused by this stage | `string` | `""` | no |
