...
NOTE: These tests are for the old boto3-based converse route which has been
...
pytestmark = pytest.mark.skip(reason="converse route moved to httpx implementation")
